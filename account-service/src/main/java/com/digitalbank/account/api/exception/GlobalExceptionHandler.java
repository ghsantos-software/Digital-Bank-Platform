package com.digitalbank.account.api.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrity(
        ...
        if (ex.getMessage() != null && ex.getMessage().contains("uk_accounts_number")) {
            message = "Account number conflict — please retry";
        }
